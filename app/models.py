...
class User(db.Model):
    ...
    email = db.Column(db.String(120), nullable=True)  # Optional, not unique to allow NULL values
    role = db.Column(db.String(20), nullable=False, default='guest')  # admin, organizer, helper, guest
